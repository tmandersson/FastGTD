...
{
    public class WhiteDocumentPageViewPeer : DocumentPageViewAutomationPeer, IValueProvider
    {
        private readonly WhitePeer whitePeer;

        public WhiteDocumentPageViewPeer(DocumentPageView owner) : base(owner)
        {
