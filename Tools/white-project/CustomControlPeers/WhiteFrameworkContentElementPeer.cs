...
{
    public class WhiteFrameworkContentElementPeer : FrameworkContentElementAutomationPeer, IValueProvider
    {
        private readonly WhitePeer whitePeer;

        public WhiteFrameworkContentElementPeer(FrameworkContentElement owner) : base(owner)
        {
